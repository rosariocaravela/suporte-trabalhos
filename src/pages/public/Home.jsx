        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 leading-7 text-gray-600">
                Desde uma avaria no computador até uma rede instável, encontre suporte adequado para cada necessidade.
              </p>
            </div>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#155E75]">Como trabalhamos</p>
            <h2 className="mt-3 text-3xl font-bold text-[#0F2747] md:text-4xl">Do problema à solução</h2>
          </div>

          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <ProcessStep icon={<ClipboardCheck />} number="01" title="Entendemos" text="Analisamos o problema e ouvimos as suas necessidades." />
            <ProcessStep icon={<Wrench />} number="02" title="Resolvemos" text="Aplicamos uma solução adequada, segura e funcional." />
            <ProcessStep icon={<Headphones />} number="03" title="Acompanhamos" text="Mantemos o apoio necessário depois da resolução." />
          </div>
        </div>
      </section>
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-7 shadow-sm">
      <div className="flex items-center justify-between text-[#155E75]">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#155E75]/10">{icon}</div>
