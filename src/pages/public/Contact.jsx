    ...
    <PublicLayout>
      <div className="bg-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
            <div className="max-w-4xl">
              ...
              <h1 className="text-5xl font-bold leading-[1.05] tracking-tight text-slate-900 sm:text-6xl lg:text-7xl">
                Vamos encontrar a <span className="text-secondary">solução tecnológica</span> certa para si.
              </h1>

              <p className="mt-8 max-w-2xl text-lg leading-8 text-gray-600 sm:text-xl">
                Conte-nos o que precisa. Estamos disponíveis para ajudar a encontrar a solução adequada às suas necessidades.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2">
              <div>
                ...
                <div className="mt-6 rounded-2xl bg-primary p-8">
                  <h3 className="text-xl font-bold text-accent">Precisa de uma resposta rápida?</h3>
                  <p className="mt-3 text-gray-200">Fale connosco diretamente pelo WhatsApp.</p>
                  <Button
                    href="https://wa.me/258842567470"
                    target="_blank"
                    rel="noreferrer"
              ...
              <div className="flex flex-col justify-center rounded-2xl bg-primary p-8 text-white shadow-sm sm:p-10">
                <div className="flex items-center justify-end gap-3">
                  <span className="rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-white/80">
                    Suporte
                  </span>
                </div>
                ...
                <div className="mt-10 border-t border-white/15 pt-6">
                  ...
                  <p className="mt-2 text-sm text-white/70">Segunda a Sábado, das 08:00 às 17:00</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-slate-900">Encontre-nos</h2>
            ...
            <div className="mt-8 flex min-h-[350px] items-center justify-center rounded-2xl bg-gray-100">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-xl font-bold text-slate-900"></h3>
                <p className="mt-2 text-gray-500">Mapa disponível para futura integração.</p>
              </div>
            </div>
          </div>
        </section>
...
function ContactItem({ icon, title, value, href, last = false }) {
  return (
    <a
      ...
      className={`flex items-center gap-5 p-6 ${!last ? "border-b border-gray-200" : ""} transition hover:bg-gray-50`}
    >
