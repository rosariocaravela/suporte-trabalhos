		...
		<PublicLayout>
			<main className="bg-white">
					...
					<div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
						<div className="max-w-4xl">
							...
							<h1 className="text-5xl font-bold leading-[1.05] tracking-tight text-[#0F2747] sm:text-6xl lg:text-7xl">
								Vamos encontrar a{" "}
								<span className="text-[#D4A72C]">solução tecnológica</span>{" "}
								certa para si.
							</h1>

							<p className="mt-8 max-w-2xl text-lg leading-8 text-gray-600 sm:text-xl">
								Conte-nos o que precisa. Estamos disponíveis para ajudar a encontrar
								a solução adequada às suas necessidades.
							</p>
						</div>
					</div>
				</section>
				...
				<section className="bg-gray-50 py-20 lg:py-28">
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						<div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2">
							{/* CONTACTOS */}
							<div>
								<h2 className="text-3xl font-bold text-[#0F2747]">Fale connosco</h2>

								<p className="mt-4 max-w-lg text-gray-600">
									Tem alguma dúvida ou precisa de suporte? Entre em contacto connosco
							...
							<div className="flex flex-col justify-center rounded-2xl bg-[#0F2747] p-8 text-white shadow-sm sm:p-10">
								...
								<h2 className="mt-4 text-3xl font-bold">Já sabe do que precisa?</h2>

								<p className="mt-4 leading-7 text-white/75">
									Envie um pedido de suporte com os detalhes do problema para receber
				...
				<section className="bg-white py-20">
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						<h2 className="text-3xl font-bold text-[#0F2747]">Encontre-nos</h2>
						...
						<div className="mt-8 flex min-h-[350px] items-center justify-center rounded-2xl bg-gray-100">
							<div className="text-center">
								<MapPin size={40} className="mx-auto text-[#155E75]" />
	...
	return (
		...
		>
			...
			<div>
				...
				<p className="mt-1 font-semibold text-[#0F2747]">{value}</p>
			</div>
		</a>
	);
}
