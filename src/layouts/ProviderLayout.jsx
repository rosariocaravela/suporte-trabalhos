		...
		<div className="min-h-screen bg-slate-50 text-slate-900 lg:flex">
			<aside className="flex w-full flex-col border-b border-slate-200 bg-white px-5 py-4 lg:min-h-screen lg:w-64 lg:border-b-0 lg:border-r lg:px-4 lg:py-6">
				...
				<nav className="flex gap-2 overflow-x-auto lg:flex-col" aria-label="Navegação do prestador">
					...
					<NavLink to="/provider/services" className={navLinkClass}><Wrench className="h-5 w-5" />Serviços</NavLink>
					<NavLink to="/provider/contents" className={navLinkClass}><BookOpenText className="h-5 w-5" />Conteúdos</NavLink>
					<NavLink to="/provider/videos" className={navLinkClass}><Clapperboard className="h-5 w-5" />Vídeos</NavLink>
